...
export interface Operation { id:string; kind:OperationKind; status:OperationStatus; amountKopecks:number; date:string; title:string; accountId?:string; toAccountId?:string; categoryId?:string; goalId?:string; required?:boolean; comment?:string }
...
export interface Obligation { id:string; name:string; amountKopecks:number; dueDate:string; categoryId?:string; paid:boolean; kind:'bill'|'loan' }
